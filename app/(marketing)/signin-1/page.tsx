          ...
          >
            ...
            <form className="space-y-6">
              <div className="space-y-2">
                <label htmlFor="signin-1-email" className="text-[10px] font-bold uppercase tracking-widest opacity-40">Email Address</label>
                <input id="signin-1-email" name="email" autoComplete="username" type="email" className="w-full border-b-2 border-zinc-100 py-3 outline-none focus:border-black transition-colors bg-transparent" placeholder="you@example.com" />
              </div>
              <div className="space-y-2">
                <label htmlFor="signin-1-password" className="text-[10px] font-bold uppercase tracking-widest opacity-40">Password</label>
                <input id="signin-1-password" name="password" autoComplete="current-password" type="password" className="w-full border-b-2 border-zinc-100 py-3 outline-none focus:border-black transition-colors bg-transparent" placeholder="••••••••" />
              </div>
