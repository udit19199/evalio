          ...
          >
            ...
            <div className="space-y-8">
              <div className="space-y-2">
                ...
                <input type="email" className="w-full border-4 border-black p-4 outline-none focus:bg-[#ffde59] transition-colors font-bold" />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-black uppercase tracking-widest">Secret Word</label>
                <input type="password" className="w-full border-4 border-black p-4 outline-none focus:bg-[#ffde59] transition-colors font-bold" />
              </div>
              <button className="w-full bg-[#4d79ff] text-white py-6 font-black text-2xl border-4 border-black shadow-[6px_6px_0px_#1a1a1a] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[10px_10px_0px_#1a1a1a] active:translate-x-0 active:translate-y-0 active:shadow-none transition-all">
                Let's Go!
              </button>
            </div>
          </motion.div>
